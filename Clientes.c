...
{
    //int sumaPorGeneroMasculino;
    int sumaPorGeneroFemenino;
    int cantidadPorGenero;
    //float promedioMasculino;
    int porcentajeFemenino;

    //sumaPorGeneroMasculino = SumaClientesSexo(listadoClientes, sizeClientes, "Masculino");
    ...
    //promedioMasculino = (float)sumaPorGeneroMasculino/cantidadPorGenero;

    porcentajeFemenino = (sumaPorGeneroFemenino*100)/cantidadPorGenero;

    //printf("PROMEDIO VARONES: %.3f \n",promedioMasculino);
